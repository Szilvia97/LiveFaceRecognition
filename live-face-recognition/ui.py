...
layout = [[psg.Text('Válaszd ki a tárgyat', size=(100, 1), font='Lucida', justification='left')],
          [psg.Combo(['Szoftverteszteles', 'OOP', 'Szoftverfejlesztes', 'Diszkret matematika', 'Kriptografia',
                      'Webtechnologiak'], key='subject')],
          ...
          [psg.Button('Kezdés', font=('Times New Roman', 12), size=(10, 1)),
...
window = psg.Window('Jelenlét', layout, size=(360, 360), auto_size_buttons=True, auto_size_text=True, resizable=True,
                    finalize=True)
